...
This macro moves the toolhead through its full range of motion, then parks at a pre-calibrated Y position to enable accurate belt frequency measurement during input shaper analysis.
