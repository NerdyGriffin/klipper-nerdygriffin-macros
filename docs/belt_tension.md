# Belt Tension Calibration (belt_tension.cfg)

Utilities for settling and measuring CoreXY belt tension using physics-based frequency calculations.

## Usage

```gcode
SETTLE_BELT_TENSION      # Cycle toolhead through full range of motion, then park for frequency measurement
```
